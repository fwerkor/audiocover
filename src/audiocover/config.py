...
class ConversionConfig(BaseModel):
    ...
    noise_scale: float = Field(default=0.12, ge=0.0, le=2.0)
    db_thresh: int = -40
...
class MixConfig(BaseModel):
    ...
    source_energy_follow: float = Field(default=0.80, ge=0.0, le=1.0)
    source_detail_amount: float = Field(default=0.25, ge=0.0, le=1.0)
    source_detail_highpass_hz: float = Field(default=4200.0, ge=1000.0, le=12000.0)
    source_detail_lowpass_hz: float = Field(default=14500.0, ge=2000.0, le=22000.0)
    source_detail_gain_limit_db: float = Field(default=4.0, ge=0.0, le=12.0)
    match_vocal_micro_dynamics: bool = True
    vocal_micro_dynamics_strength: float = Field(default=0.62, ge=0.0, le=1.0)
    vocal_micro_dynamics_gain_limit_db: float = Field(default=3.0, ge=0.0)
    vocal_micro_dynamics_frame_ms: float = Field(default=18.0, ge=5.0)
    vocal_micro_dynamics_hop_ms: float = Field(default=5.0, ge=1.0)
    vocal_micro_dynamics_attack_ms: float = Field(default=4.0, ge=1.0)
    vocal_micro_dynamics_release_ms: float = Field(default=36.0, ge=1.0)
    match_vocal_dynamics: bool = True
    vocal_dynamics_strength: float = Field(default=1.0, ge=0.0, le=1.0)
    vocal_dynamics_gain_limit_db: float = Field(default=10.0, ge=0.0)
    vocal_dynamics_attack_ms: float = Field(default=16.0, ge=1.0)
    vocal_dynamics_release_ms: float = Field(default=120.0, ge=1.0)
    match_vocal_macro_dynamics: bool = True
    vocal_macro_dynamics_strength: float = Field(default=0.90, ge=0.0, le=1.0)
