...
class ConversionConfig(BaseModel):
    ...
    noise_scale: float = Field(default=0.18, ge=0.0, le=2.0)
    db_thresh: int = -40
...
class MixConfig(BaseModel):
    ...
    vocal_saturation_amount: float = Field(default=0.17, ge=0.0, le=1.0)
    vocal_saturation_drive_db: float = Field(default=4.0, ge=0.0, le=12.0)
    parallel_compression_mix: float = Field(default=0.20, ge=0.0, le=1.0)
    parallel_compression_threshold_db: float = -24.0
    parallel_compression_ratio: float = Field(default=4.0, ge=1.0, le=20.0)
    parallel_compression_makeup_db: float = Field(default=1.8, ge=0.0, le=12.0)
    vocal_body_gain_db: float = Field(default=1.45, ge=-6.0, le=6.0)
    vocal_body_freq_hz: float = Field(default=220.0, ge=40.0, le=800.0)
    vocal_body_q: float = Field(default=0.8, gt=0.0, le=8.0)
    vocal_warmth_gain_db: float = Field(default=0.9, ge=-6.0, le=6.0)
    ...
    reverb_highcut_hz: float = Field(default=7800.0, ge=1000.0, le=20000.0)
